...
//
// `code` is the KeyboardEvent.code (not .key) so shortcuts keep working
// regardless of what modifier keys do to the character a given keyboard
// layout produces for digits/symbols.
...
export const PADS: PadDef[] = [
  { id: "crash", label: "Crash", key: "1", code: "Digit1", hue: 0 },
  { id: "cowbell", label: "Cowbell", key: "2", code: "Digit2", hue: 30 },
  { id: "laser", label: "Laser", key: "3", code: "Digit3", hue: 60 },
  { id: "tomroll", label: "Tom Roll", key: "4", code: "Digit4", hue: 90 },
  ...
  { id: "rimshot", label: "Rimshot", key: "=", code: "Equal", hue: 330 },
];
